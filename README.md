...
## 설계<br/>
<img width="310" alt="서버분석1" src="https://user-images.githubusercontent.com/80368992/122233395-fd302680-cef6-11eb-97f3-d789f3880cfa.jpg">
...
읽어온 파일 디스크립터 (read_fds) 중 비트가 0으로 set되어 있는것을 검사하고 (!!이부분 다시 )
